...
export default function Footer() {
  return (
    <footer className="py-6 px-4 bg-gradient-to-r from-blue-600 to-purple-600 text-center text-blue-100">
      
      <p className="text-sm mb-4">
        Thanks for being part of our growing community! ❤️
      </p>
      ...
      <div className="flex flex-wrap justify-center items-center gap-4 mb-4">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex items-center gap-2 px-4 py-2 bg-white text-gray-900 rounded-md shadow hover:bg-gray-200 transition font-semibold text-sm"
        >
          ⭐ Star MockAPI
        </a>
      </div>
      ...
      <div className="flex justify-center gap-5 mt-2">
        ...
        {/* GitHub */}
        <a
          href="https://github.com/manikandan-1704/"
          target="_blank"
          rel="noopener noreferrer"
        ...
        {/* LinkedIn */}
        <a
          href="https://www.linkedin.com/in/manikandan-s1704/"
          target="_blank"
          rel="noopener noreferrer"
          className="hover:text-white transition"
        >
